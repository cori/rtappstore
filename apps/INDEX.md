...
|-----|------|---------|--------|------------|------|-------------|-----------------|-------------|
| [adventurelog](https://github.com/cori/rtappstore/tree/main/apps/adventurelog) | AdventureLog | v0.13.0 | Sean Morley | utilities, data | 8015 | [code](https://github.com/seanmorley15/AdventureLog) · [website](https://adventurelog.app) | [postgis/postgis](https://postgis/postgis) | Self-hostable travel tracker and trip planner with interactive maps and itineraries |
| [atlantis](https://github.com/cori/rtappstore/tree/main/apps/atlantis) | Atlantis | sha-590dbb7 | Fantastic Computing Machine | utilities, data | 8240 | [https://github.com/Fantastic-Computing-Machine/atlantis](https://github.com/Fantastic-Computing-Machine/atlantis) | [strikead/atlantis](https://strikead/atlantis) | Self-hosted platform for Mermaid.js diagrams and knowledge management |
| [blinko](https://github.com/cori/rtappstore/tree/main/apps/blinko) | Blinko | 1.8.5 | blinko-space | utilities, data | 1111 | [https://github.com/blinkospace/blinko](https://github.com/blinkospace/blinko) | [postgres](https://hub.docker.com/r/postgres) | AI-powered self-hosted personal note-taking app |
| [filament-profiles](https://github.com/cori/rtappstore/tree/main/apps/filament-profiles) | Filament Profiles | 0.2.0 | cori | utilities, data | 7920 | [https://github.com/cori/filament-profiles](https://github.com/cori/filament-profiles) | [postgres](https://hub.docker.com/r/postgres) | Print settings management companion for Spoolman |
| [flowchart](https://github.com/cori/rtappstore/tree/main/apps/flowchart) | flowchart | sha-e1df4dc | cori | utilities, data | 8384 | [https://github.com/cori/flowchart](https://github.com/cori/flowchart) | [ghcr.io](ghcr.io/cori/flowchart) | Self-hosted PWA for tracking FPV freestyle drone training progress, sessions, and trick mastery |
...
## Legend
- **App**: Directory name (link to app config in this repo)
- **Source Code**: Link to upstream source repository
- **Container Image**: Link to container registry (GHCR, Docker Hub, etc.)
- **Version**: Docker image version (matches config.json)
